...
import useDetermineMembershipCardDetails from './hooks/useDetermineMembershipCardDetails'
...
const WeFoundYou = () => {
  ...
  const { planName, cardName } = useDetermineMembershipCardDetails()
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.root__description}>
        <p className={styles.root__paragraph}>You already have a {planName} {cardName}.</p>
