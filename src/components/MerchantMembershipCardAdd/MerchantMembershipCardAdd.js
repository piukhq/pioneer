...
const MerchantMembershipCardAdd = ({ planId }) => {
  ...
  return (
    <div className={styles.root}>
      ...
      <p className={styles.root__summary}>You already have a {plan?.account?.plan_name} {plan?.account?.plan_name_card?.toLowerCase()} registered to <span className={styles.root__userId}>{userId}</span>.</p>
